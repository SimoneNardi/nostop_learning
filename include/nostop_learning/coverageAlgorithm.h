...
////////////////////////////////////////////////////
#ifndef COVERAGE_ALGORITHM_H
#define COVERAGE_ALGORITHM_H
#pragma once 
...
namespace Robotics 
{
	namespace GameTheory
	{
		...
		void setLostBattery(double _lostBattery);
...
#pragma region Test
		...
		public:
			...
			//int getTime() const;
			void printPotential(std::string const& name, bool printOnFile = true, bool energy=false);
			void printBenefit(std::string const& name, bool printOnFile = true, bool energy=false);
			...
			void printBenefitPortionIndex(std::string const& name, bool printOnFile = true);
