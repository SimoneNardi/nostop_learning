	...
	, m_count(0)
{
	...
	std::shared_ptr<LearningAlgorithm> l_learning = nullptr; //CONTROLLARE
	if(_type == 0)
	...
	l_learning->setExperimentalRate(0.);
...
//////////////////////////////////////////////////////////////////////////
void CoverageAlgorithm::printPotential(std::string const& _filename, bool printOnFile, bool energy)
{
	// 	return m_stats.printPotential(_filename, printOnFile, energy);
}

//////////////////////////////////////////////////////////////////////////
void CoverageAlgorithm::printBenefit(std::string const& _filename, bool printOnFile, bool energy)
{
	// 	return m_stats.printBenefit(_filename, printOnFile, energy);
}
...
//////////////////////////////////////////////////////////////////////////
void CoverageAlgorithm::printBenefitPortionIndex(std::string const& name, bool _print)
{
	// 	return m_stats.printBenefitPortionIndex(name, _print);
}
...
void CoverageAlgorithm::printPhoto(std::string const& _outputFileName)
{
	...
	l_file << "Potential Index " << l_potentialIndex << std::endl;
	double l_benefitIndex = this->getTrajectoryBenefitIndex();
	l_file << "Benefit Index " << l_benefitIndex << std::endl;
	double l_coverageIndex = this->getTrajectoryCoverage();
	l_file << "Coverage Index " << l_coverageIndex << std::endl;
	double l_explorationRate = m_learning->computeExplorationRate();
	l_file << "Esploration Rate " << l_explorationRate << std::endl;
